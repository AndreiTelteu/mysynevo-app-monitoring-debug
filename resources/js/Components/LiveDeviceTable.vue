<script setup>
import { ref } from 'vue';
import DeviceNickname from '@/Components/DeviceNickname.vue';
            ...
            <table>
                ...
                <tbody>
                    <tr v-for="device in devices" :key="device.id">
                        ...
                        <td><DeviceNickname :nickname="device.nickname || ''" :placeholder="displayName(device)" @save="(value) => emit('update-nickname', device, value)" /><small>{{ device.device.manufacturer || 'Unknown maker' }} · {{ device.device.osVersion || 'Unknown OS' }}</small><code>{{ device.deviceId }}</code></td>
